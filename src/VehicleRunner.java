public class VehicleRunner
{
    public static void main(String[] args)
    {
        ...
        Bicycle myBike2 = new Bicycle("Bone Buster 3000", 3, 69);
        System.out.println(myBike2.getName());
        System.out.println(myBike2.getWheels());
        System.out.println(myBike2.getGearCount());
        myBike2.move(1);
        myBike2.turn(2);
        myBike2.brake(0.5);
        myBike2.ringBell();
